			...
			function OverviewPage(props) {
			  ...
			  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "oss-page", children: [
			    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "oss-page-header", children: [
			      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "oss-back-btn", type: "button", title: "\u8FD4\u56DE\u5DE5\u4F5C\u533A", "aria-label": "\u8FD4\u56DE\u5DE5\u4F5C\u533A", onClick: props.onBack, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(IconChevronLeftOutline14, { size: 14 }) }),
			      ...
			      projects === null ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "oss-muted", children: "\u52A0\u8F7D\u4E2D\u2026" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "oss-project-list", children: [
			        ...
			        projects.map((project) => {
			          ...
			          return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "oss-card", children: [
			            ...
			            project.changes.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "oss-muted", children: "\u65E0\u6D3B\u8DC3\u63D0\u6848" }) : project.changes.map((change) => {
			              const artifacts = ["proposal", "design", "specs", "tasks"].map((key) => change.artifacts[key] ? key : null).filter((v) => v !== null);
			              return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "oss-entry", children: [
