window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		(function (require, module, exports) {
			      ...
			      projects === null ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "oss-muted", children: "\u52A0\u8F7D\u4E2D\u2026" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "oss-project-list", children: [
			        ...
			        projects.map((project) => {
			          ...
			          return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "oss-card", children: [
			            ...
			            archived.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArchivedSection, { changes: archived, onOpenFile: (file, changeName) => {
			              if (!openInBetterSidebar(file.path, `${changeName}/${file.label}`)) {
			                setPreview({ change: changeName, file, projectPath: project.path });
			              }
			            } })
			...
			function phaseLabel(change) {
			  if (change.phase === "archived") return change.archivedAt !== void 0 ? `\u5DF2\u5F52\u6863 ${change.archivedAt}` : "\u5DF2\u5F52\u6863";
			...
			function ArchivedSection(props) {
			  ...
			  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "oss-archived", children: [
			    ...
			    open && props.changes.map((change) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChangeRow, { change, onOpenFile: props.onOpenFile }, change.name))
			  ] });
			}
			function ChangeRow(props) {
			  ...
			  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `oss-change ${change.phase === "archived" ? "is-archived" : ""}`, children: [
			    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
			      "div",
			      {
			        ...
			        children: [
			          ...
			          change.tasks.total > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "oss-muted oss-nowrap", children: [
			            change.tasks.done,
			            "/",
			            change.tasks.total
			          ] }),
			          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `oss-phase ${change.phase}`, children: phaseLabel(change) })
			        ]
			      }
			    ),
