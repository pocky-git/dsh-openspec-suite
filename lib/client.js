	...
	factory: (require) => {
		...
		(function (require, module, exports) {
			  ...
			  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
			    "svg",
			    {
			      ...
			      children: [
			        ...
			        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M9.4 0.9v2.5H11.9L9.4 0.9Z", fill: "currentColor" })
			      ]
			    }
			  );
			}
			...
			function OverviewPage(props) {
			  ...
			  const runNewChange = async (project, description) => {
			    ...
			    try {
			      ...
			      for (let attempt = 0; attempt < 20; attempt += 1) {
			        ...
			        const current = ctx.sessions.list.getSnapshot().current;
			        if (current !== void 0 && !before.has(current)) {
			          newSessionId = current;
			          break;
			        }
			      }
			  ...
			  const [newChangeDialog, setNewChangeDialog] = React.useState(null);
			  ...
			  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "oss-page", children: [
			    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "oss-page-header", children: [
			      ...
			      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
			        "button",
			        {
			          ...
			          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(IconRefreshOutline14, { size: 14, spinning: refreshing })
			        }
			      ),
			      ...
			      projects === null ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "oss-muted", children: "\u52A0\u8F7D\u4E2D\u2026" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "oss-project-list", children: [
			        ...
			        projects.map((project) => {
			          ...
			          return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "oss-card", children: [
			            ...
			            active.length === 0 && archived.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "oss-muted", children: "\u65E0\u63D0\u6848" }),
			            active.map((change) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
			              ChangeRow,
			              {
			                change,
			                project,
			            ...
			            archived.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArchivedSection, { changes: archived, project, onOpenFile: (file, changeName) => {
			              if (openInBetterSidebar(file.path, `${changeName}/${file.label}`)) return;
			              setPreview({ change: changeName, file, projectPath: project.path });
			            }, onLocate: (changeName) => {
			              void (async () => {
			    ...
			    newChangeDialog !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
			      NewChangeDialog,
			      {
			...
			function NewChangeDialog(props) {
			  ...
			  if (dialog.sent) {
			    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "oss-modal-overlay", onClick: props.onClose, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "oss-modal oss-modal-success", role: "dialog", "aria-label": "\u63D0\u6848\u521B\u5EFA\u6210\u529F", onClick: (e) => e.stopPropagation(), children: [
			      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "oss-modal-success-icon", children: "\u2713" }),
			      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "oss-modal-title", children: "\u63D0\u6848\u521B\u5EFA\u6210\u529F" }),
			      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "oss-muted oss-modal-desc", children: [
			        "\u5DF2\u5728\u300C",
			        dialog.project.name,
			        "\u300D\u4E0B\u65B0\u5EFA\u4F1A\u8BDD\u5E76\u53D1\u9001 /openspec-new-change\uFF0C\u6B63\u5728\u751F\u6210\u63D0\u6848\u2026"
			      ] }),
			      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "oss-btn-primary", onClick: props.onClose, children: "\u77E5\u9053\u4E86" })
			    ] }) });
			  }
			  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "oss-modal-overlay", onClick: busy ? void 0 : props.onClose, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "oss-modal", role: "dialog", "aria-label": "\u521B\u5EFA\u63D0\u6848", onClick: (e) => e.stopPropagation(), children: [
			    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "oss-modal-title", children: "\u521B\u5EFA\u63D0\u6848" }),
			    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "oss-muted oss-modal-desc", children: [
			      "\u5C06\u5728\u300C",
			      dialog.project.name,
			    ...
			    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "oss-row oss-modal-actions", children: [
			      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "oss-grow" }),
			      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "oss-btn", disabled: busy, onClick: props.onClose, children: "\u53D6\u6D88" }),
			      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "oss-btn-primary", disabled: !canSubmit, onClick: () => props.onSubmit(dialog.description), children: busy ? "\u521B\u5EFA\u4E2D\u2026" : "\u521B\u5EFA" })
			    ] })
			  ] }) });
			}
			...
			function ArchivedSection(props) {
			  ...
			  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "oss-archived", children: [
			    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
			      "div",
			      {
			        ...
			        children: [
			          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `oss-caret ${open ? "is-open" : ""}`, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(IconChevronRightOutline12, { size: 12 }) }),
			          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "oss-muted", style: { flex: 1, minWidth: 0 }, children: [
			            "\u5DF2\u5F52\u6863\uFF08",
			    ...
			    open && props.changes.map((change) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChangeRow, { change, project: props.project, onOpenFile: props.onOpenFile, onLocate: props.onLocate }, change.name))
			  ] });
			}
			function ChangeRow(props) {
			  ...
			  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `oss-change ${archived ? "is-archived" : ""}`, children: [
			    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
			      "div",
			      {
			        ...
			        children: [
			          ...
			          archived && change.archivedAt !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "oss-muted oss-nowrap", children: change.archivedAt })
			        ]
			      }
			    ),
			...
			function OpenSpecHtmlViewer(props) {
			  ...
			  if (error !== "") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "oss-err", children: error });
			  if (url === "") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "oss-muted", children: "\u52A0\u8F7D\u4E2D\u2026" });
			  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("iframe", { className: "oss-preview-frame", src: url, title: props.title, sandbox: "allow-scripts" });
			}
			function registerSidebarViewers(ctx) {
			  ...
			  try {
			    return register({
			      ...
			      priority: 10,
			      fetchStrategy: "none",
			      component: (props) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(OpenSpecHtmlViewer, { path: props.path, title: props.title })
			    });
			  } catch {
			    return void 0;
			  }
